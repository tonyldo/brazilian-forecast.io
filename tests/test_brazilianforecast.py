...
class CurrentWeatherTests(unittest.TestCase):
   ...
   def test_current_get_reading(self):
       ...
       self.assertEqual(current.get_reading('temperature'),current._conditions['temperatura'])
       self.assertEqual(current.get_reading('weather'),current._conditions['tempo'])
       self.assertEqual(current.get_reading('pressure'),current._conditions['pressao'])
   ...
   def test_current_station_condition(self):
       try:
           sbar_station = BrazilianCurrentWeather().set_station(Station('SBAR')).get_station_current_conditions()
